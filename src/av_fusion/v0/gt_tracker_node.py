...
class LidarClusterDetector(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info("🚀 LiDAR Clustering Detector (NO Open3D)")
    ...
    def callback(self, msg):
        ...
        mask = (dist < 40) & (points[:, 0] > 0) & (np.abs(points[:, 1]) < 15)
        ...
        points = points[::3]   # simple thinning
