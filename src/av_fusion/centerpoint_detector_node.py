...
CONFIG = "configs/centerpoint_config.py"
CHECKPOINT = "checkpoints/centerpoint.pth"


class CenterPointDetector(Node):

    def __init__(self):
        super().__init__("centerpoint_detector")
        ...
        self.get_logger().info("CenterPoint Detector Started")
